...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <title><?php echo $title ?> | Bootphp <?php echo 'User Guide'; ?></title>
        ...
        <div id="kodoc-header">
            <div class="container">
                <a href="http://kilofox.net/" id="kodoc-logo">
                    <img src="<?php echo Route::url('docs/media', array('file' => 'img/bootphp.png')) ?>" />
                </a>
                <div id="kodoc-menu">
                    <ul>
                        ...
                        <?php if (Core::$config->load('userguide.api_browser')): ?>
                            <li class="api">
        ...
        <div id="kodoc-footer">
            <div class="container">
                ...
                <div class="span-12 last right">
                    <p>Powered by <?php echo HTML::anchor('http://kilofox.net/', 'Bootphp') ?> v<?php echo Core::VERSION ?></p>
                </div>
            </div>
        </div>
        ...
        <?php if (Core::$environment === Core::PRODUCTION): ?>
            <script type="text/javascript">
                ...
                (function() {
                    ...
                    document.write('<script charset="utf-8" type="text/javascript" src="http://disqus.com/forums/bootphp/get_num_replies.js' + query + '"></' + 'script>');
                })();
                //]]>
            </script>
        <?php endif ?>
