...
Bootphp provides a set of useful rules in the [Valid] class:
...
[!!] In Bootphp controllers, we access `$this->request->post()` instead of `$_POST` for better request isolation.
