...
<div id="bootphp_error">
    <h1><span class="type">BootphpException [ 0 ]:</span> <span class="message">The requested view site could not be found</span></h1>
    <div id="error4ac2453378034" class="content">
        <p><span class="file">SYS_PATH/classes/bootphp/view.php [ 215 ]</span></p>
        <pre class="source"><code><span class="line"><span class="number">210</span> 	 */
            ...
            <li>
                <p>
                    ...
                    <span class="file">
                        <a href="#error4ac2453378034source0" onclick="return koggle('error4ac2453378034source0')">SYS_PATH/classes/bootphp/view.php [ 115 ]</a>
                    </span>
                    &raquo;
                    Bootphp_View->set_filename(<a href="#error4ac2453378034args0" onclick="return koggle('error4ac2453378034args0')">arguments</a>)
                </p>
            ...
            <li>
                <p>
                    <span class="file">
                        <a href="#error4ac2453378034source1" onclick="return koggle('error4ac2453378034source1')">SYS_PATH/classes/bootphp/view.php [ 26 ]</a>
                    </span>
                    &raquo;
                    Bootphp_View->__construct(<a href="#error4ac2453378034args1" onclick="return koggle('error4ac2453378034args1')">arguments</a>)
                </p>
            ...
            <li>
                <p>
                    ...
                    <span class="file">
                        <a href="#error4ac2453378034source2" onclick="return koggle('error4ac2453378034source2')">SYS_PATH/classes/bootphp/controller/template.php [ 32 ]</a>
                    </span>
                    &raquo;
                    Bootphp_View::factory(<a href="#error4ac2453378034args2" onclick="return koggle('error4ac2453378034args2')">arguments</a>)
                </p>
            ...
            <li>
                <p>
                    ...
                    &raquo;
                    Bootphp_Controller_Template->before()
                </p>
            ...
            <li>
                <p>
                    <span class="file">
                        <a href="#error4ac2453378034source4" onclick="return koggle('error4ac2453378034source4')">SYS_PATH/classes/bootphp/request.php [ 840 ]</a>
                    </span>
                    &raquo;
    ...
    <small>public</small> request => <small>object</small> <span>Request(9)</span> <code>{
        ...
        <small>protected</small> _params => <small>array</small><span>(0)</span>
            ...
            <li>
                <p>
                    <span class="file">
                        <a href="#error4ac2453378034source5" onclick="return koggle('error4ac2453378034source5')">APP_PATH/bootstrap.php [ 76 ]</a>

                    </span>
                    &raquo;
                    Bootphp_Request->execute()
                </p>
            ...
            <li>
                ...
                <div id="error4ac2453378034args6" class="collapsed">
                    <table cellspacing="0">
                        <tr>
                            <td><code>0</code></td>
                            <td><pre><small>string</small><span>(49)</span> "/var/www/bootphp/testing/application/bootstrap.php"</pre></td>
                        </tr>
...
</span><span class="line"><span class="number">102</span> 	require SYS_PATH . 'classes/bootphp.php';
...
</span><span class="line highlight"><span class="number">106</span> require APP_PATH . 'bootstrap.php';
</span></code></pre></code></pre>
            </li>
        </ol>
    </div>
    ...
    <div id="error4ac2453378034environment" class="content collapsed">
        ...
        <div id="error4ac2453378034environment_included" class="collapsed">
            <table cellspacing="0">
                ...
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/core.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp.php</code></td>
                </tr>
                <tr>
                    <td><code>APP_PATH/bootstrap.php</code></td>

                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/profiler.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/profiler.php</code></td>
                </tr>
                <tr>

                    <td><code>SYS_PATH/classes/bootphp/log.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/config.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/log/file.php</code></td>

                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/log/writer.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/config/file.php</code></td>
                </tr>
                <tr>

                    <td><code>SYS_PATH/classes/bootphp/config/reader.php</code></td>
                </tr>
                <tr>
                    <td><code>MOD_PATH/codebench/init.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/route.php</code></td>

                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/route.php</code></td>
                </tr>
                <tr>
                    <td><code>/var/www/bootphp/userguide/init.php</code></td>
                </tr>
                <tr>

                    <td><code>SYS_PATH/classes/request.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/request.php</code></td>
                </tr>
                <tr>
                    <td><code>APP_PATH/classes/controller/hello.php</code></td>

                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/controller/template.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/controller/template.php</code></td>
                </tr>
                <tr>

                    <td><code>SYS_PATH/classes/controller.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/controller.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/view.php</code></td>

                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/view.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/view/exception.php</code></td>
                </tr>
                <tr>

                    <td><code>SYS_PATH/classes/bootphp/exception.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/i18n.php</code></td>
                </tr>
                <tr>
                    <td><code>SYS_PATH/classes/bootphp/i18n.php</code></td>

                </tr>
                <tr>
                    <td><code>SYS_PATH/views/bootphp/error.php</code></td>
                </tr>
            </table>
        </div>
...
"</pre></td>
                ...
                <tr>
                    ...
                    <td><pre><small>string</small><span>(33)</span> "/var/www/bootphp/testing/index.php"</pre></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><pre><small>string</small><span>(31)</span> "/bootphp/testing/index.php/hello"</pre></td>
                </tr>
                <tr>
                    <td><code>SCRIPT_NAME</code></td>
                    <td><pre><small>string</small><span>(25)</span> "/bootphp/testing/index.php"</pre></td>
