...
/**
 * Tests the bootphp text class (Bootphp_Text)
 *
 * @group bootphp
 * @group bootphp.core
 * @group bootphp.core.text
 *
 */
class Bootphp_TextTest extends Unittest_TestCase
{
    /**
    ...
    function provider_reduce_slashes()
    {
        return array
            (
            array('/', '//'),
            array('/google/php/bootphp/', '//google/php//bootphp//'),
        );
    }
    ...
    function provider_censor()
    {
        ...
        return array
            ...
            array("Cake### isn't nearly as good as bootphp###", "CakePHP isn't nearly as good as bootphpphp", array('php'), '#', true),
    ...
    function provider_widont()
    {
        return array
             ...
             * array(
             * 		'with HTML at the end &nbsp;<strong>Bootphp</strong>',
             * 		'with HTML at the end <strong>Bootphp</strong>',
             * 	),
             * 	// @issue 3499, with HTML with attributes at the end
             * 	array(
             * 		'with HTML at the end:&nbsp;<a href="#" title="Bootphp">Bootphp</a>',
             * 		'with HTML at the end: <a href="#" title="Bootphp">Bootphp</a>',
             * 	),
             */
            array(
    ...
    public function provider_auto_link()
    {
        return array(
            array(
                'Hi there, my site is kilofox.net and you can email me at nobody@kilofox.net',
                array('kilofox.net'),
            ),
            array(
     ...
     * @test
     */
    public function test_user_agent_acceptsArray()
    {
