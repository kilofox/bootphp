...
/**
 * Tests the Validation lib that's shipped with Bootphp
 *
 * @group bootphp
 * @group bootphp.core
 * @group bootphp.core.validation
 *
 ...
 */
class Bootphp_ValidationTest extends Unittest_TestCase
{
    /**
    ...
    public function provider_check()
    {
        ...
        return array(
            ...
            array(
                ...
                array('foo' => array(array('in_array', array('bootphp', ':value')))),
                [],
                false,
    ...
    public function provider_errors()
    {
        ...
        return array(
            ...
            array(
                array('username' => 'John'),
                array('username' => array(array('strpos', array(':value', 'Bootphp')))),
    ...
    /**
     * Tests Validation::asArray()
     *
     * @test
     * @covers Validation::as_array
     */
    public function test_as_array_returns_originalArray()
    {
        $data = array(
            'one' => 'hello',
            'two' => 'world',
        ...
        $this->assertSame($data, $validation->asArray());
    }
     ...
     */
    public function test_data_returns_originalArray()
    {
        $data = array(
            'one' => 'hello',
            'two' => 'world',
    ...
    // @codingStandardsIgnoreEnd
    {
        $this->setExpectedException('BootphpException');
    ...
    /**
     * http://dev.kilofox.net/issues/4365
     *
     * @test
     * @covers Validation::errors
     */
    ...
    /**
     * http://dev.kilofox.net/issues/4201
     *
     * @test
     * @ticket 4201
     * @covers Validation::rule
