 ...
 */
class Bootphp_SessionTest extends Unittest_TestCase
{
    /**
    ...
    /**
     * asArray() should return the session data by reference.
     *
    ...
    public function test_set_adds_and_modifies_to_session_data()
    {
        ...
        $this->assertAttributeSame(
            array('pork' => 'pie'), '_data', $session
        );

        $session->set('pork', 'delicious');

        $this->assertAttributeSame(
            array('pork' => 'delicious'), '_data', $session
        );
    }
    ...
    public function test_delete_removes_select_session_data()
    {
        ...
        // that asArray() is returning by ref
    ...
    public function test_destroy_only_deletes_data_if_driver_destroys_session()
    {
        ...
        $this->assertAttributeSame(
            array('asd' => 'dsa', 'dog' => 'god'), '_data', $session
        );
    }
