 ...
 */
class Bootphp_HttpTest extends Unittest_TestCase
{
    ...
    {
        parent::setUp();
        Core::$config->load('url')->set('trusted_hosts', array('www\.example\.com'));
    ...
    public function provider_redirect()
    {
        return array(
            ...
            array(
                ...
                302,
                'HTTP_Exception_302',
                'http://www.example.com/bootphp/index.php/page_one'
            ),
            array(
                'page_two',
                303,
                'HTTP_Exception_303',
                'http://www.example.com/bootphp/index.php/page_two'
            ),
        );
    }
