...
/**
 * Unit Tests for Bootphp_HTTP_Header
 *
 * @group bootphp
 * @group bootphp.core
 * @group bootphp.core.http
 * @group bootphp.core.http.header
 * @group bootphp.core.http.header
 *
 ...
 */
class Bootphp_HTTP_HeaderTest extends Unittest_TestCase
{
    /**
    ...
    public function test_send_headers(array $state, array $expected, $expose)
    {
        ...
        $this->assertSame(
            $expected, $response->send_headers(false, array($this, 'send_headers_handler'))
        );
    }
