...
/**
 * Tests the Config file reader that's shipped with bootphp
 *
 * @group bootphp
 ...
 */
class Bootphp_Config_File_ReaderTest extends Bootphp_Unittest_TestCase
{
    /**
     ...
     *
     * @test
     * @covers Bootphp_Config_File_Reader
     */
     ...
     *
     * @test
     * @covers Bootphp_Config_File_Reader::load
     */
