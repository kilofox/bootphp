...
class Bootphp_RouteTest extends Unittest_TestCase
{
    ...
    // @codingStandardsIgnoreEnd
    {
        ...
        Core::$config->load('url')->set('trusted_hosts', array('bootphpframework\.org'));
     ...
     * it should throw a BootphpException
     *
    ...
    /**
     * Check appending cached routes. See http://dev.kilofox.net/issues/4347
     *
     * @test
     * @covers Route::cache
     */
    ...
    public function test_constructor_returns_if_uri_is_null()
    {
        ...
        $route = $this->getMock('Route', array('_compile'), [], '', false);
    ...
    public function test_uri_throws_exception_if_required_params_are_missing($uri, $regex, $uri_array)
    {
        ...
        $this->setExpectedException('BootphpException', 'controller');
        $route->uri($uri_array);
    }
    ...
    public function provider_composing_url_from_route()
    {
        return array(
            ...
            array('http://kilofox.net/news', array('controller' => 'news'), 'http')
        );
    }
    ...
    public function test_composing_url_from_route($expected, $params = null, $protocol = null)
    {
        ...
        $this->setEnvironment(array(
            '_SERVER' => array('HTTP_HOST' => 'kilofox.net'),
            'Core::$base_url' => '/',
            'Core::$index_file' => '',
        ));
    ...
    /**
     * http://dev.kilofox.net/issues/4079
     *
     * @test
     * @covers Route::get
     * @ticket 4079
