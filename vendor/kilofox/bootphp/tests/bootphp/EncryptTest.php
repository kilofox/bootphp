 ...
 * @group bootphp
 * @group bootphp.core
 * @group bootphp.core.encrypt
 *
 * @author      Tinsh <kilofox2000@gmail.com>
 * @author     Samuel Demirdjian <sam@enov.ws>
 * @copyright  (c) 2014 Bootphp Team
 * @license     http://kilofox.net/bootphp/license
 */
class Bootphp_EncryptTest extends Unittest_TestCase
{
    /**
    ...
    {
        // initialize
        $e = new Bootphp_EncryptTest_IvStubbed($key, $iv, $mode, $cipher);
    ...
    public function test_key_normalization($key, $iv, $mode, $cipher, $txt_plain)
    {
        ...
        // initialize, encode twice
        $e1 = new Bootphp_EncryptTest_IvStubbed($key, $iv, $mode, $cipher);
        $e2 = new Bootphp_EncryptTest_KeyNormalized($key, $iv, $mode, $cipher);
    ...
    {
        // load config
        $config = Core::$config->load('encrypt');
...
/**
 * Class Bootphp_EncryptTest_IvStubbed wraps the Encrypt class to mock out
 * the actual mcrypt_create_iv calls for unit testing.
 */
class Bootphp_EncryptTest_IvStubbed extends Encrypt
{
    /**
...
/**
 * Class Bootphp_EncryptTest_KeyNormalized wraps the Encrypt class to mock out
 * the actual mcrypt_create_iv calls for unit testing, as well as to always
 * normalize keys
 */
class Bootphp_EncryptTest_KeyNormalized extends Bootphp_EncryptTest_IvStubbed
{
    /**
