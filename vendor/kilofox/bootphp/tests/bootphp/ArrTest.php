...
/**
 * Tests the Arr lib that's shipped with bootphp
 *
 * @group bootphp
 * @group bootphp.core
 * @group bootphp.core.arr
 *
 ...
 */
class Bootphp_ArrTest extends Unittest_TestCase
{
    /**
    ...
    public function provider_callback()
    {
        return array(
            ...
            array('bootphp::appify(this)', array(array('bootphp', 'appify'), array('this'))),
    ...
    public function provider_extract()
    {
        return array(
            array(
                array('bootphp' => 'awesome', 'blueflame' => 'was'),
                array('bootphp', 'cakephp', 'symfony'),
                null,
                array('bootphp' => 'awesome', 'cakephp' => null, 'symfony' => null)
            ),
    ...
    public function provider_path()
    {
        $array = array(
            ...
            'users' => array(
                1 => array('name' => 'matt'),
                2 => array('name' => 'john', 'interests' => array('hocky' => array('length' => 2), 'football' => [])),
                3 => 'frank', // Issue #3194
            ),
        ...
        return array(
            ...
            array($array['bootphp'], $array, 'bootphp'),
            ...
            array(null, $array, 'bootphp.alternatives', null),
            // Try using a string as a default
            array('nothing', $array, 'bootphp.alternatives', 'nothing'),
    ...
    public function provider_set_path()
    {
        return array(
            ...
            array(array('bootphp' => array('is' => 'awesome')), [], 'bootphp.is', 'awesome'),
            array(array('bootphp' => array('is' => 'cool', 'and' => 'slow')),
                array('bootphp' => array('is' => 'cool')), 'bootphp.and', 'slow'),
            // Custom delimiters
            array(array('bootphp' => array('is' => 'awesome')), [], 'bootphp/is', 'awesome', '/'),
            ...
            array(array('bootphp' => array('is' => 'awesome')), [], array('bootphp', 'is'), 'awesome'),
        );
    }
