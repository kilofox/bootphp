...
/**
 * @author     Woody Gilk <woody.gilk@bootphpphp.com>
 */
class Bench_DateSpan extends Codebench
{
    ...
    public static function bench_span_useArray($remote, $local = null, $output = 'years,months,weeks,days,hours,minutes,seconds')
    {
        // Array with the output formats
        $output = preg_split('/[^a-z]+/', strtolower((string) $output));
