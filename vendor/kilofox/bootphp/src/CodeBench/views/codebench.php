...
<?php if (Core::$config->load('codebench')->expand_all) { ?>
...
<?php } ?>
    ...
    <!--[if IE]><p class="alert">This page is not meant to be viewed in Internet Explorer. Get a better browser.</p><![endif]-->
        ...
        <p id="footer">
            Page executed in <strong><?php echo round(microtime(true) - START_TIME, 2) ?>&nbsp;s</strong>
            using <strong><?php echo Text::widont(Text::bytes(memory_get_usage(), 'MB')) ?></strong> of memory.<br />
            <a href="http://github.com/bootphp/codebench">Codebench</a>, a <a href="http://kilofox.net/">Bootphp</a> module
