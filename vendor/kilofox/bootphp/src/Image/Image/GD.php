...
class Bootphp_Image_GD extends Image
{
    ...
    public static function check()
    {
        if (!function_exists('gd_info')) {
            throw new BootphpException('GD is either not installed or not enabled, check your configuration');
        }
        $functions = array(
        ...
        if (!version_compare($version, '2.0.1', '>=')) {
            throw new BootphpException('Image_GD requires GD version :required or greater, you have :version', array('required' => '2.0.1', ':version' => $version));
        }
    ...
    public function __construct($file)
    {
        ...
        if (!isset($create) or ! function_exists($create)) {
            throw new BootphpException('Installed GD does not support :type images', array(':type' => image_type_to_extension($this->type, false)));
        }
    ...
    protected function _do_rotate($degrees)
    {
        if (empty(Image_GD::$_available_functions[Image_GD::IMAGEROTATE])) {
            throw new BootphpException('This method requires :function, which is only available in the bundled version of GD', array(':function' => 'imagerotate'));
        }
    ...
    protected function _do_sharpen($amount)
    {
        if (empty(Image_GD::$_available_functions[Image_GD::IMAGECONVOLUTION])) {
            throw new BootphpException('This method requires :function, which is only available in the bundled version of GD', array(':function' => 'imageconvolution'));
        }
    ...
    protected function _do_reflection($height, $opacity, $fade_in)
    {
        if (empty(Image_GD::$_available_functions[Image_GD::IMAGEFILTER])) {
            throw new BootphpException('This method requires :function, which is only available in the bundled version of GD', array(':function' => 'imagefilter'));
        }
    ...
    protected function _do_watermark(Image $watermark, $offset_x, $offset_y, $opacity)
    {
        if (empty(Image_GD::$_available_functions[Image_GD::IMAGELAYEREFFECT])) {
            throw new BootphpException('This method requires :function, which is only available in the bundled version of GD', array(':function' => 'imagelayereffect'));
        }
    ...
    protected function _save_function($extension, & $quality)
    {
        ...
        switch (strtolower($extension)) {
            ...
            case 'png':
                ...
                break;
            default:
                throw new BootphpException('Installed GD does not support :type images', array(':type' => $extension));
                break;
        }
