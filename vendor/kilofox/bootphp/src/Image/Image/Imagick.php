...
class Bootphp_Image_Imagick extends Image
{
    ...
    public static function check()
    {
        if (!extension_loaded('imagick')) {
            throw new BootphpException('Imagick is not installed, or the extension is not loaded');
        }
    ...
    protected function _get_imagetype($extension)
    {
        ...
        switch ($format) {
            ...
            case 'png':
                ...
                break;
            default:
                throw new BootphpException('Installed ImageMagick does not support :type images', array(':type' => $extension));
                break;
        }
