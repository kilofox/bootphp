...
Es wird dazu ermutigt, dem Bootphp [Programmierstil](http://dev.kohanaframework.org/wiki/kohana2/CodingStyle) zu folgen. Dieser benutzt den [Allman/BSD](http://de.wikipedia.org/wiki/Einr%C3%BCckungsstil#Allman_.2F_BSD_.2F_.E2.80.9EEast_Coast.E2.80.9C_.2F_Horstmann)-Stil.
...
Bootphp benutzt für Namen Unter_striche, keine BinnenVersalien (camelCase).
...
#### Klassen
	...
	// Libary extension, uses Bootphp_ prefix
	class Beer extends Bootphp_Beer {
