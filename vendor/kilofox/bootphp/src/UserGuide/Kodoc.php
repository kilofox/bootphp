...
class Bootphp_Kodoc
{
     ...
     * >  For example:  class_methods( Core::list_files('classes/sprig') ) could make a nice index page for the sprig package in the api browser
     * >     ~bluehawk
     *
     */
    ...
    {
        $api_packages = Core::$config->load('userguide.api_packages');
    ...
    public static function is_transparent($class, $classes = null)
    {
        ...
        if (!$transparent_prefixes) {
            $transparent_prefixes = Core::$config->load('userguide.transparent_prefixes');
        }
