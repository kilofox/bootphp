 ...
 */
class Bootphp_Database_MySQL_Result extends Database_Result
{
    ...
    public function current()
    {
        ...
        if ($this->_as_object === true) {
             ...
             * PHP 5.3, the resulting behavior is identical to calling with [], which results in the
             ...
             * replaced by mysqli_fetch_object or PDOStatement::fetch(PDO::FETCH_OBJ) in Bootphp 3.4.
             */
