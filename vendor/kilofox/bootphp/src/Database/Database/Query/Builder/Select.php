 ...
 */
class Bootphp_Database_Query_Builder_Select extends Database_Query_Builder_Where
{
    // SELECT ...
    protected $_select = [];
    // DISTINCT
    ...
    public function using($columns)
    {
        ...
        call_user_funcArray(array($this->_last_join, 'using'), $columns);
    ...
    public function union($select, $all = true)
    {
        ...
        if (!$select instanceof Database_Query_Builder_Select)
            throw new BootphpException('first parameter must be a string or an instance of Database_Query_Builder_Select');
