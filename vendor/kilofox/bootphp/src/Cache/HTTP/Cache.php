...
class Bootphp_HTTP_Cache
{
     ...
     *
     * @param   Bootphp_Cache  $cache    engine to use for caching
     * @return  Bootphp_Cache
     * @return  Bootphp_Request_Client
     */
    ...
    public function cache_key_callback($callback = null)
    {
        ...
        if (!is_callable($callback))
            throw new BootphpException('cache_key_callback must be callable!');
     ...
     * [Bootphp_Response] returned by [Request::execute].
     *
