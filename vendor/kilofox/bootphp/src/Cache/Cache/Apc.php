...
/**
 * [Bootphp Cache](api/Bootphp_Cache) APC driver. Provides an opcode based
 * driver for the Bootphp Cache library.
 *
 ...
 */
class Bootphp_Cache_Apc extends Cache implements Cache_Arithmetic
{
    /**
