 ...
 */
class Bootphp_Cache_Sqlite extends Cache implements Cache_Tagging, Cache_GarbageCollect
{
    /**
     * Database resource
     *
    ...
    protected function __construct(array $config)
    {
        ...
        if ($database === null) {
            throw new Cache_Exception('Database path not available in Bootphp Cache configuration');
        }
        ...
        if (0 == count($result)) {
            ...
            if ($database_schema === null) {
                throw new Cache_Exception('Database schema not found in Bootphp Cache configuration');
            }
