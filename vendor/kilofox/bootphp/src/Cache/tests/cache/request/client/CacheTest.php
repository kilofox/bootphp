 ...
 * @group bootphp.request.client.cache
 *
 * @author      Tinsh <kilofox2000@gmail.com>
 * @copyright   (C) 2013-2017 Kilofox Studio
 * @license     http://kilofox.net/bootphp/license
 */
class Bootphp_Request_Client_CacheTest extends Unittest_TestCase
{
    /**
    ...
    public function test_cache_miss()
    {
        ...
        $route->defaults(array(
            'controller' => 'Bootphp_Request_CacheTest_Dummy',
            'action' => 'index',
        ));
    ...
    public function test_cache_save()
    {
        ...
        $this->assertSame(HTTP_Cache::CACHE_STATUS_SAVED, $response->headers(HTTP_Cache::CACHE_STATUS_KEY));
    }
...
// End Bootphp/Request/Client/CacheTest
class Controller_Bootphp_Request_CacheTest_Dummy extends Controller
{
