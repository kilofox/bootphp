 ...
 * or by extending `Bootphp_Cache` class) to the name of the group, and use:
 *
...
abstract class Bootphp_Cache
{
    ...
    /**
     * @var   Bootphp_Cache instances
     */
    public static $instances = [];

    /**
     * Creates a singleton of a Bootphp Cache group. If no group is supplied
    ...
    public static function instance($group = null)
    {
        ...
        if (!$config->offsetExists($group)) {
            ...
            'Failed to load Bootphp Cache group: :group', array(':group' => $group)
            );
        }
    ...
    {
        throw new Cache_Exception('Cloning of Bootphp_Cache objects is forbidden');
    }
