 ...
 * with object properties representing row data. ORM in Bootphp generally follows
...
class Bootphp_ORM extends Model implements serializable
{
    ...
    public function __isset($column)
    {
        return isset($this->_object[$column]) ||
            ...
            isset($this->_has_one[$column]) ||
            isset($this->_belongs_to[$column]) ||
    ...
    protected function _build($type)
    {
        ...
        foreach ($this->_db_pending as $method) {
            ...
            call_user_funcArray(array($this->_db_builder, $name), $args);
        }
    ...
    protected function _load_result($multiple = false)
    {
        ...
        $this->_db_builder->selectArray($this->_build_select());
